        ...
        <div class="voucher-footer">
            <div class="voucher-details">
                <div class="details-icon">
                    ...
                    <svg version="1.1" id="time_icon" width="24" height="24" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 24 24"
                        style="enable-background:new 0 0 24 24;" xml:space="preserve">
                        <g>
                            <path fill="none" d="M0,0h24v24H0V0z"></path>
                            <path fill="#ffefed" d="M12,2.5c-5.2,0-9.5,4.3-9.5,9.5s4.3,9.5,9.5,9.5"></path>
                            <path fill="#ff4933"
                ...
                <div class="details-text">
                    ...
                    <div class="text-description text-dark">12 Jun 2019</div>
                </div>
            </div>
            <div class="voucher-details">
                <div class="details-icon">
                    ...
                    <!--?xml version="1.0" encoding="utf-8"?-->
                    <!-- Generator: Adobe Illustrator 22.1.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->
                    <svg version="1.1" id="ringgit_icon" width="28" height="28" xmlns="http://www.w3.org/2000/svg"
                        xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 24 24"
                        style="enable-background:new 0 0 24 24;" xml:space="preserve">
                        <path fill="#ffefed"
                ...
                <div class="details-text">
                    ...
                    <div class="text-description text-dark">none</div>
                </div>
            </div>
        </div>
    </div>
